...
class ProjectManagerAgent:
                        ...
                        if fields_to_keep:
                            ...
                            for field in fields_to_keep:
                                if hasattr(self.project_knowledge_base.worldbuilding, field):
                                    value = getattr(
                                        self.project_knowledge_base.worldbuilding, field
                                    )
    ...
    def run_agent(self, agent_name: str, *args, **kwargs):
        ...
        if agent_name in [
            ...
            if self.project_knowledge_base:
                try:
                    agent.execute(
                        project_knowledge_base=self.project_knowledge_base, *args, **kwargs
    ...
    def write_and_review_chapter(self, chapter_number: int):
        ...
        if self.project_knowledge_base and self.project_knowledge_base.review_preference == "AI":
            ...
            self.project_knowledge_base and self.project_knowledge_base.review_preference == "Human"
        ):
    ...
    def format_book(self, output_path: str):
        ...
        try:
            ...
            if missing_revised_chapters:
                console.print(
                    f"[yellow]Info: {
    len(missing_revised_chapters)} chapters don't have revised versions[/yellow]"
                )
    ...
    def research(self, query: str):
        ...
        self.run_agent("researcher", query, str(
            self.project_dir / "research_results.md"))  # type: ignore
    ...
    def review_content(self, chapter_number: int):
        ...
        print(
            f"Content review results for chapter {chapter_number}:\n{
    results.get(
    ...
    def create_title_page(
        ...
        author = project_knowledge_base.get(
            "author", "Unknown Author"
        )  # Assuming you might add author later
